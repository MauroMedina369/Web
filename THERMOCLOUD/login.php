...
<!--                     
                        ...
                        <form class="mt-4">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <p class="text-dark quicksandd" for="pwd" >Contraseña</p>
                                        <input class="form-control" id="pwd" style="font-family:Quicksand" type="password" placeholder="Contraseña" >
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 text-center mt-5" style="margin-top:-20px">
                                    ¿Olvidaste tu contraseña? <a href="ForgetPass.php" class="text-primary">Hacé click acá</a>
                                </div>                                
                            </div>
                        </form>
                    </div>
